...
g++ -I$SYSTEMC_HOME/include -L$SYSTEMC_HOME/lib-linux64 -I/usr/local/systemc-ams-2.3.4/include -L/usr/local/systemc-ams-2.3.4/lib-linux64 tlmProyecto2.cpp  -lsystemc -lsystemc-ams -lm -o top.o 2>&1 | tee -a "$LOG_FILE"
