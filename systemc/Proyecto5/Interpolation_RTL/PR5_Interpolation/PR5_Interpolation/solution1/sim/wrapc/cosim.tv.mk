...
$(ObjDir)/interpolation_tb_RTL.cpp_pre.cpp.tb.o : interpolation_tb_RTL.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling interpolation_tb_RTL.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/interpolation_RTL.cpp_pre.cpp.tb.o : interpolation_RTL.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling interpolation_RTL.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
