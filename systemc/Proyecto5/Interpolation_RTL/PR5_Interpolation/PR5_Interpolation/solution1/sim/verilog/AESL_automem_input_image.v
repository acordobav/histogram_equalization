...
module AESL_automem_input_image (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.interpolate_image.autotvin_input_image.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.interpolate_image.autotvout_input_image.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 19;
parameter DEPTH = 32'd 420546;
parameter DLY = 0.1;
