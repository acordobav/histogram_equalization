...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.interpolate_image.autotvin_input_image.dat"
         "c.interpolate_image.autotvin_output_image.dat"
         "c.interpolate_image.autotvout_output_image.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.interpolate_image.autotvout_output_image.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
