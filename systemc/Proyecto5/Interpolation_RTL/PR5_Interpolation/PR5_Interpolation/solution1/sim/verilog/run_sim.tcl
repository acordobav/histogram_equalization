...
if {[file isfile interpolate_image.autotvin.dat]} {
	file delete -force interpolate_image.autotvin.dat
}

if {[file isfile interpolate_image.autotvout.dat]} {
	file delete -force interpolate_image.autotvout.dat
}
