...
module AESL_automem_output_image (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.interpolate_image.autotvin_output_image.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.interpolate_image.autotvout_output_image.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 17;
parameter DEPTH = 32'd 98304;
parameter DLY = 0.1;
