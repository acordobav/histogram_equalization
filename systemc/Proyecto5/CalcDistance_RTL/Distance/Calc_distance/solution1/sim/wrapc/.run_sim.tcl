...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "top.autotvin.dat"
	set constFileTvOut       "top.autotvout.dat"
	set constFileHdlTvIn     "top.autohdltvin.dat"
	set constFileHdlTvOut    "top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
