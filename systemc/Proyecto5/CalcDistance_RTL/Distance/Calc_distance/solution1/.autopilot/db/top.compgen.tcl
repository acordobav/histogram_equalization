...
set id 1
set name top_dmul_64ns_64ns_64_5_max_dsp_1
...
set id 2
set name top_sitodp_32ns_64_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_simulated_time \
    op interface \
    ports { simulated_time { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dist_cm \
    op interface \
    ports { dist_cm { O 32 vector } dist_cm_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_calc_voltage \
    op interface \
    ports { calc_voltage { O 64 vector } calc_voltage_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sens_range \
    op interface \
    ports { sens_range { O 32 vector } sens_range_ap_vld { O 1 bit } } \
} "
}
